...
namespace R3Modeller.CrossPlatform.AttachedProperties {
    /// <summary>
    ...
    public static class ControlInteractivity {
        private static readonly MouseButtonEventHandler MouseUpCommandProperty_OnMouseUp = (s, e) => MouseCommand_OnMouseEvent((UIElement) s, e, true);
        private static readonly MouseButtonEventHandler MouseUpCommandProperty_OnMouseDown = (s, e) => MouseCommand_OnMouseEvent((UIElement) s, e, false);
            ...
            DependencyProperty.RegisterAttached(
                ...
                new PropertyMetadata(
                    ...
                    (d, e) => {
                        ...
                        ui.MouseUp -= MouseUpCommandProperty_OnMouseUp;
                        if (e.NewValue != null)
                            ui.MouseUp += MouseUpCommandProperty_OnMouseUp;
                    }));
            ...
            DependencyProperty.RegisterAttached(
                ...
                new PropertyMetadata(
                    ...
                    (d, e) => {
                        if (!(d is UIElement ui))
                            throw new Exception("This property must be applied to a UIElement");
                        ui.MouseDown -= MouseUpCommandProperty_OnMouseDown;
                        if (e.NewValue != null)
                            ui.MouseDown += MouseUpCommandProperty_OnMouseDown;
                    }));
